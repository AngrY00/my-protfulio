            ...
            <div className="h-[400vh] relative z-10 w-full">
                ...
                <div className="sticky top-0 h-screen w-full flex items-center justify-center p-6 md:p-20 overflow-hidden">
                    ...
                    <div className="absolute left-4 md:left-12 top-1/2 -translate-y-1/2 flex flex-col gap-6 z-50">
                        ...
                        <ProgressItem scrollY={scrollYProgress} number="02" label="EDUCATION" start={0.15} end={0.40} />
                        <ProgressItem scrollY={scrollYProgress} number="03" label="ACHIEVEMENTS" start={0.40} end={0.65} />
                        <ProgressItem scrollY={scrollYProgress} number="04" label="PHILOSOPHY" start={0.65} end={0.88} />
                        <ProgressItem scrollY={scrollYProgress} number="05" label="VISION" start={0.88} end={1.0} />
                    </div>
                    ...
                    <FirstSection end={0.15}>
                        <div className="text-center max-w-4xl px-8 ml-10 md:ml-0">
                            <h1 className="text-4xl md:text-6xl font-light tracking-tight mb-8 leading-tight text-white/90">
                                I didn't start with a CS degree.
                            </h1>
                            <h1 className="text-4xl md:text-6xl font-light tracking-tight text-orange-100/80">
                                I started with <span className="italic font-serif">a problem to solve.</span>
                            </h1>
                        </div>
                    </FirstSection>
                    ...
                    <LastSection start={0.88}>
                        <div className="text-center max-w-2xl px-4 pl-8 md:pl-0">
                            ...
                            <p className="text-xs text-white/30 mt-2 tracking-widest">AI AGENT DEVELOPER · AUTOMATION ENGINEER · LOGISTICS TECH BUILDER</p>
                        </div>
                    </LastSection>
...
const ProgressItem = ({ scrollY, number, label, start, end }) => {
    ...
    const color = useTransform(activeState, [0, 1], ["rgba(255,255,255,0.2)", "#fb923c"]);
    ...
    return (
        <div className="flex items-center gap-3">
            <motion.span style={{ color, scale }} className="text-[10px] font-mono transition-colors">
                {number}
            </motion.span>
            <motion.div style={{ width: lineW, backgroundColor: color }} className="h-[1px]" />
            <motion.span
                style={{
                    x: labelX,
